...
public class ReportesContoller {
    ...
    @GetMapping(path = "/reporteria/formularios/{estudiante}", produces = MediaType.TEXT_HTML_VALUE)
    @ResponseBody
    public String obtenerFormulariosPorEstudiante(HttpServletResponse response, @PathVariable String  estudiante, Model model ){
